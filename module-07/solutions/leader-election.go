// Solution: Leader Election Configuration from Module 7
// This demonstrates how kubebuilder's cmd/main.go enables leader election for high availability
// Note: This is based on kubebuilder-generated code structure
...
func main() {
	...
	// Leader election is disabled by default in kubebuilder, enable via flag
	...
	// Disable HTTP/2 for webhook server if not enabled (security best practice)
